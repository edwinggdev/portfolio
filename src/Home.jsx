...
import {rrss} from './components/Const'
export function Home() {
  ...
  return (
    ...
    <section className='fluid-container' style={{backgroundColor: myBlue,paddingTop:20  }} >
      ...
      <div className='row'>
        <div className='' >
          <div className='col-lg-12' style={{ backgroundImage: `url("images/foto01.png")`, backgroundRepeat: 'no-repeat', backgroundSize:'cover', backgroundPosition:'center' , height:550}} >
                    ...
                    <div className='px-5 pt-5'>
                      ...
                      { rrss.map(item=>(
                        <a href={item.link} title={item.title}>
                          <FontAwesomeIcon key={item.icon} icon={item.icon}  style={{ 'color': "white", fontSize: 32 }} className='mx-2'/>
                        </a>
